...
const DICTIONARY = {
  es: {
    ...
    admin_stat_attending: 'asistentes confirmados',
    admin_stat_guests: 'asistentes totales',
    admin_stat_declined: 'no podrán asistir',
  ...
  en: {
    ...
    admin_stat_attending: 'confirmed attendees',
    admin_stat_guests: 'total attendees',
    admin_stat_declined: "can't attend",
    admin_th_name: 'Name',
