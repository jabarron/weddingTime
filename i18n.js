...
const DICTIONARY = {
  es: {
    ...
    admin_stat_attending: 'Invitaciones confirmadas',
    admin_stat_guests: 'Total de asistentes',
    admin_stat_declined: 'Invitaciones declinadas',
  ...
  en: {
    ...
    admin_stat_attending: 'Confirmed invitations',
    admin_stat_guests: 'Total attendees',
    admin_stat_declined: 'Declined invitations',
    admin_th_name: 'Name',
