...
const DICTIONARY = {
  es: {
    ...
    rsvp_email: 'Correo electrónico (opcional)',
    ...
    rsvp_meal: 'Elección de platillo',
    rsvp_meal_placeholder: 'Selecciona una opción',
  ...
  en: {
    ...
    rsvp_meal: 'Meal choice',
    rsvp_meal_placeholder: 'Select an option',
