...
const DICTIONARY = {
  es: {
    ...
    admin_title: 'RSVP',
    admin_responses_heading: 'Respuestas',
    ...
    admin_stat_attending: 'Confirmadas',
    admin_stat_guests: 'Totales',
    admin_stat_declined: 'Declinadas',
  ...
  en: {
    ...
    admin_title: 'RSVP',
    admin_responses_heading: 'Responses',
    ...
    admin_stat_attending: 'Confirmed',
    admin_stat_guests: 'Total',
    admin_stat_declined: 'Declined',
    admin_th_name: 'Name',
